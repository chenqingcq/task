    ...
    <div class="task-detail-slide">
      <div class="panel c-1 c_white-bg">
        ...
        <div class="task-progress">
          <span class="task-desc" @touchstart='toggleTaskProgress'>展台基础已布置完毕</span>
...
export default {
  data() {
    return {
      ...
      taskDesc: `任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述任务描述`,
